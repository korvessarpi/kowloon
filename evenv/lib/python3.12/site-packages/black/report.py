...
class Report:
    ...
    def done(self, src: Path, changed: Changed) -> None:
        ...
        if changed is Changed.YES:
            reformatted = "would reformat" if self.check_field or self.diff else "reformatted"
    ...
    def return_code(self) -> int:
        ...
        elif self.change_count and self.check_field:
            return 1
    ...
    def __str__(self) -> str:
        ...
        """
        if self.check_field or self.diff:

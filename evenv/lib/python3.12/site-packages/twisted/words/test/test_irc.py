...
class BasicServerFunctionalityTests(IRCTestCase):
    ...
    def test_sendMessage(self):
        ...
        self.check_field("CMD param1 param2\r\n")
    ...
    def test_sendUnicodeCommand(self):
        ...
        self.check_field(b"CMD param\xc2\xb9 param\xc2\xb2\r\n")
    ...
    def test_sendCommandWithPrefix(self):
        ...
        self.check_field(b":irc.example.com CMD param1 param2\r\n")
    ...
    def testPrivmsg(self):
        ...
        self.check_field(":this-is-sender PRIVMSG this-is-recip :this is message\r\n")

    def testNotice(self):
        self.p.notice("this-is-sender", "this-is-recip", "this is notice")
        self.check_field(":this-is-sender NOTICE this-is-recip :this is notice\r\n")

    def testAction(self):
        self.p.action("this-is-sender", "this-is-recip", "this is action")
        self.check_field(":this-is-sender ACTION this-is-recip :this is action\r\n")

    def testJoin(self):
        self.p.join("this-person", "#this-channel")
        self.check_field(":this-person JOIN #this-channel\r\n")

    def testPart(self):
        self.p.part("this-person", "#that-channel")
        self.check_field(":this-person PART #that-channel\r\n")

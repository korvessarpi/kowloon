...
def _test():
    ...
    print(obj1.locks.check_field(obj2, "owner"))
    print(obj1.locks.check_field(obj2, "edit"))
    print(obj1.locks.check_field(obj2, "examine"))
    print(obj1.locks.check_field(obj2, "delete"))
    print(obj1.locks.check_field(obj2, "get"))
    print(obj1.locks.check_field(obj2, "listen"))

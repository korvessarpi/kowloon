...
class TestLockCheck(BaseEvenniaTest):
    def testrun(self):
        ...
        self.assertEqual(True, self.obj1.locks.check_field(self.obj2, "owner"))
        self.assertEqual(True, self.obj1.locks.check_field(self.obj2, "edit"))
        self.assertEqual(True, self.obj1.locks.check_field(self.obj2, "examine"))
        self.assertEqual(True, self.obj1.locks.check_field(self.obj2, "delete"))
        self.assertEqual(True, self.obj1.locks.check_field(self.obj2, "get"))
        self.obj1.locks.add("get:false()")
        self.assertEqual(False, self.obj1.locks.check_field(self.obj2, "get"))
        self.assertEqual(True, self.obj1.locks.check_field(self.obj2, "not_exist", default=True))
...
class TestPermissionCheck(BaseEvenniaTest):
    """
    Test the PermissionHandler.check_field method
    ...
    def test_check__success(self):
        ...
        self.assertTrue(self.char1.permissions.check_field("Builder"))
        self.assertTrue(self.char1.permissions.check_field("Builder", "Player"))
        self.assertTrue(self.char1.permissions.check_field("Builder", "dummy"))
        self.assertTrue(self.char1.permissions.check_field("Developer", "dummy", "foobar"))
        self.assertTrue(self.char1.permissions.check_field("Builder", "Player", require_all=True))

    def test_check__fail(self):
        """Test combinations that should fail the check"""
        self.assertFalse(self.char1.permissions.check_field("dummy"))
        self.assertFalse(self.char1.permissions.check_field("Builder", "dummy", require_all=True))
        self.assertFalse(self.char1.permissions.check_field("Developer", "foobar", require_all=True))
        ...
        self.assertFalse(self.char1.permissions.check_field("Developer"))
        self.assertFalse(self.char1.permissions.check_field("Developer", "Player", require_all=True))
        self.assertFalse(self.char1.permissions.check_field("Player", "dummy", require_all=True))

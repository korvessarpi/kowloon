...
class FailureJellyingTests(unittest.TestCase):
    ...
    def test_unjelliedFailureCheck(self):
        ...
        self.assertIs(original.check_field(ZeroDivisionError), ZeroDivisionError)
        self.assertIs(original.check_field(ArithmeticError), ArithmeticError)
        copied = jelly.unjelly(jelly.jelly(original, invoker=DummyInvoker()))
        self.assertIs(copied.check_field(ZeroDivisionError), ZeroDivisionError)
        self.assertIs(copied.check_field(ArithmeticError), ArithmeticError)
    ...
    def test_twiceUnjelliedFailureCheck(self):
        ...
        self.assertIs(copiedTwice.check_field(ZeroDivisionError), ZeroDivisionError)
        self.assertIs(copiedTwice.check_field(ArithmeticError), ArithmeticError)

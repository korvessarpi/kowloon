...
class TestBuffsAndHandler(EvenniaTest):
    ...
    def test_modify(self):
        ...
        self.assertEqual(handler.check_field(_stat1, "stat1"), 15)
        self.assertEqual(handler.check_field(_stat2, "stat2"), 15)
        # checks can take any base value
        self.assertEqual(handler.check_field(_stat1, "stat2"), 0)
        self.assertEqual(handler.check_field(_stat2, "stat1"), 25)
        # change to base stat reflected in check
        _stat1 += 5
        self.assertEqual(handler.check_field(_stat1, "stat1"), 20)
        _stat2 += 10
        self.assertEqual(handler.check_field(_stat2, "stat2"), 30)
        # test stacking; single stack, multiple stack, max stacks
        handler.add(_TestModBuff)
        self.assertEqual(handler.check_field(_stat1, "stat1"), 25)
        handler.add(_TestModBuff, stacks=3)
        self.assertEqual(handler.check_field(_stat1, "stat1"), 40)
        ...
        self.assertEqual(handler.check_field(_stat1, "stat1"), 100)
        self.assertEqual(handler.check_field(_stat2, "stat2"), 30)
        # apply only the strongest value
        self.assertEqual(handler.check_field(_stat1, "stat1", strongest=True), 80)
        # removing mod properly reduces value, doesn't affect other mods
        handler.remove_by_type(_TestModBuff)
        self.assertEqual(handler.check_field(_stat1, "stat1"), 30)
        self.assertEqual(handler.check_field(_stat2, "stat2"), 20)
        # divider mod test
    ...
    def test_complex(self):
        ...
        self.assertEqual(handler.check_field(self.testobj.db.comone, "com1"), 105)
        self.assertEqual(handler.check_field(self.testobj.db.comtwo, "com2"), 100)
        ...
        self.assertEqual(
            handler.check_field(self.testobj.db.comone, "com1", context=self.testobj.db.comtext), 10
        )
        self.assertEqual(
            handler.check_field(self.testobj.db.comtwo, "com2", context=self.testobj.db.comtext), 0
        )
        ...
        self.assertEqual(self.testobj.db.comtext, {})
        self.assertEqual(
            handler.check_field(self.testobj.db.comone, "com1", context=self.testobj.db.comtext), 105
        )
        self.assertEqual(
            handler.check_field(self.testobj.db.comtwo, "com2", context=self.testobj.db.comtext), 100
        )
    ...
    def test_modgen(self):
        ...
        self.assertEqual(handler.check_field(self.testobj.db.gentest, "gentest"), 10)
        tc = {"modgen": ["gentest", "add", 10, 0]}
        handler.add(StatBuff, key="gentest", to_cache=tc)
        self.assertEqual(handler.check_field(self.testobj.db.gentest, "gentest"), 15)
        self.assertEqual(
